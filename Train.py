...
def train(train_loader, model, optimizer, epoch, test_path):
    ...
    test1path = './datasetpoly/TestDataset'
    if (epoch + 1) % 1 == 0:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str,
                        default='./datasetpoly/TrainDataset/',

                        help='path to train dataset')

    parser.add_argument('--test_path', type=str,
                        default='./datasetpoly/TestDataset',
    ...
    logging.basicConfig(filename='trainlog.log',
    ...
    train_loader = get_loader(image_root, gt_root, batchsize=opt.batchsize, trainsize=opt.trainsize, num_workers=2,
